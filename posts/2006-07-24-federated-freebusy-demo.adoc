...
The specific objectives of the proof-of-concept project were: • a
real-time mechanism; +
• ability to extract and collate/display free/busy information; • at
least three major calendaring systems; +
• +
open standard protocols; and • can be implemented today.
...
information on The Open Group can be found at .
